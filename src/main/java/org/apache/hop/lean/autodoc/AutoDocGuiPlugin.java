...
public class AutoDocGuiPlugin {
  ...
  public void generateDocumentation() {
    ...
    String baseFolderPath =
        BaseDialog.presentDirectoryDialog(hopGui.getShell(), hopGui.getVariables());
    if (baseFolderPath == null) {
      return;
    }

    try {
      FileObject baseFolder = HopVfs.getFileObject(variables.resolve(baseFolderPath));
      ...
      LeanPage a4 = LeanPage.getA4(1, true);
      ...
      // Convert to a PDF...
      //
      results.saveSvgPages("/tmp/autodoc", "autodoc", true, true, true);

      // Save the presentation JSON...
      //
      String json = presentation.toJsonString(true);
      try (FileOutputStream fos = new FileOutputStream("/tmp/autodoc/autodoc-presentation.json")) {
  ...
  protected static LeanComponent createHeaderLabelComponent(String headerMessage) {
    ...
    labelLayout.setTop(
        new LeanAttachment(null, 0, 0, LeanAttachment.Alignment.CENTER));
